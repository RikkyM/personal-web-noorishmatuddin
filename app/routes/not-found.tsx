...
export default function NotFoundPage() {
  return (
    <section className="font-georgia flex h-[90vh] bg-white">
      <div className="m-auto max-w-7xl p-6 text-center">
        <h1 className="mb-2 text-5xl font-semibold text-black">404</h1>
        ...
        <Link
          to="/"
          className="bg-[#840000] px-4 py-1.5 text-sm font-medium text-white"
        >
          Kembali ke Beranda
        </Link>
      </div>
